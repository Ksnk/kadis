...
<div class="col-sm-8 col-lg-8 col-8" style="overflow:auto;">
    ...
    <label class="radio-inline"><input type="radio" name="words">Словосочетания</label>
    <label class="radio-inline"><input type="radio" name="link">ссылки</label>
    <label class="radio-inline"><input type="radio" name="picture">картинки</label>
    </div></div>
    <div class="row">
